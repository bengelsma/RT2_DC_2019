...
author: "Brian Engelsma"
date: "9/13/2019"
output: html_document
---

# A Description of the Birthday Problem  

A description of the birthay problem. Da da da da. 
...
Ok, I am convinced that the probability of atl least two people in this room share the same birthday is `r round(birthday.prob(n.pers.param,n.sims.param), 2)`
